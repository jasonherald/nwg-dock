...
pub(crate) const EDGE_THRESHOLD: i32 = 2;
...
pub(crate) const DEFAULT_BG_RGB: (u8, u8, u8) = (54, 54, 79);
...
pub(crate) const DRAG_CLAIM_THRESHOLD: f64 = 8.0;
...
pub(crate) const LAUNCH_ANIMATION_TIMEOUT_SECS: u64 = 10;

/// Peak bounce height in pixels for the launch animation.
pub(crate) const LAUNCH_BOUNCE_HEIGHT_PX: i32 = 12;

/// Small downward dip in pixels at the bottom of the bounce cycle.
pub(crate) const LAUNCH_BOUNCE_DIP_PX: i32 = 4;

/// Duration of one full bounce cycle in milliseconds.
pub(crate) const LAUNCH_BOUNCE_DURATION_MS: i32 = 600;
...
pub(crate) const WORKSPACE_ROW_SPACING: i32 = 0;
