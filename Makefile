...
setup-hyprland:
	...
	@echo "#"
	@echo "# Hyprland LUA config (Omarchy 4.0+): autostart.conf is not read."
	@echo "# Add to ~/.config/hypr/autostart.lua instead:"
	@echo "o.launch_on_start([[$(BIN_NAME) -d -i 48 --mb 10 --hide-timeout 400 --opacity 75 --launch-animation -c \"nwg-drawer --pb-auto\"]])"
